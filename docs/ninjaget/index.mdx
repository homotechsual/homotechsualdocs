...
For NinjaGet to work we need to create some device custom fields in NinjaOne. We need the following fields:

| Purpose                       | Type               | Default Name      |
| ----------------------------- | ------------------ | ----------------- |
| Store the last run date/time. | Date
