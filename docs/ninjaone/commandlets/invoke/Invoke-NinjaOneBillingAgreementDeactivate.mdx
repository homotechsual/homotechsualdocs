...
```powershell
Invoke-NinjaOneBillingAgreementDeactivate [-id] <Int32> [-ProgressAction <ActionPreference>] [-WhatIf]
...
```powershell
Invoke-NinjaOneBillingAgreementDeactivate -id 1
```
...
[https://docs.homotechsual.dev/modules/ninjaone/commandlets/Invoke/billingagreement-deactivate](https://docs.homotechsual.dev/modules/ninjaone/commandlets/Invoke/billingagreement-deactivate)
