---
id: billing-invoices-export
title: Billing Invoices Export
hide_title: false
...
```powershell
Invoke-NinjaOneBillingInvoicesExport [-Request] <Object> [-ProgressAction <ActionPreference>] [-WhatIf]
...
```powershell
Invoke-NinjaOneBillingInvoicesExport -Request @{ invoiceIds = @(1,2) }
```
...
[https://docs.homotechsual.dev/modules/ninjaone/commandlets/Invoke/billinginvoices-export](https://docs.homotechsual.dev/modules/ninjaone/commandlets/Invoke/billinginvoices-export)
