---
id: Invoke-NinjaOneOrganisationRestore
...
```powershell
Invoke-NinjaOneOrganisationRestore [-request] <Object> [-ProgressAction <ActionPreference>] [-WhatIf]
...
```powershell
Invoke-NinjaOneOrganisationRestore -Identity 123
```
