---
id: Invoke-NinjaOneUnmanagedDeviceDecommission
...
```powershell
Invoke-NinjaOneUnmanagedDeviceDecommission [-NodeId] <Int32> [-ProgressAction <ActionPreference>] [-WhatIf]
...
```powershell
Invoke-NinjaOneUnmanagedDeviceDecommission -NodeId 1
```
...
[https://docs.homotechsual.dev/modules/ninjaone/commandlets/Invoke/unmanageddevicedecommission](https://docs.homotechsual.dev/modules/ninjaone/commandlets/Invoke/unmanageddevicedecommission)
