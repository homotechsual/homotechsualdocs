---
id: New-NinjaOneAttachmentRelation
...
[https://docs.homotechsual.dev/modules/ninjaone/commandlets/New/attachmentrelation`n`t](https://docs.homotechsual.dev/modules/ninjaone/commandlets/New/attachmentrelation`n`t)
