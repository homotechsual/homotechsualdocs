...
```powershell
New-NinjaOneAssetRelationship [-AssetRelationship] <Object> [-ProgressAction <ActionPreference>] [-WhatIf]
...
```powershell
New-NinjaOneAssetRelationship -AssetRelationship @{ entityId = 1; relEntityId = 2 }
```
...
[https://docs.homotechsual.dev/modules/ninjaone/commandlets/New/assetrelationship](https://docs.homotechsual.dev/modules/ninjaone/commandlets/New/assetrelationship)
