---
title: New-NinjaOneDocumentTemplateFieldObject
id: new-ninjaonedocumenttemplatefieldobject
description: "Creates a new Document Template Field object containing required / specified properties / structure."
hide_title: false
