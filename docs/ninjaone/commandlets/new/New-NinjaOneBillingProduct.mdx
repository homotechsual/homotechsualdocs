...
```powershell
New-NinjaOneBillingProduct [-billingProduct] <Object> [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```powershell
New-NinjaOneBillingProduct -billingProduct @{ name = 'Managed Endpoint' }
```
...
[https://docs.homotechsual.dev/modules/ninjaone/commandlets/New/billingproduct](https://docs.homotechsual.dev/modules/ninjaone/commandlets/New/billingproduct)
