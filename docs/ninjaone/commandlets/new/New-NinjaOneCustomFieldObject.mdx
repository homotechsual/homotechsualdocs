---
title: New-NinjaOneCustomFieldObject
id: new-ninjaonecustomfieldobject
description: "Creates a new Custom Field object containing required / specified properties / structure."
hide_title: false
