---
id: New-NinjaOneEntityRelations
...
[https://docs.homotechsual.dev/modules/ninjaone/commandlets/New/entityrelations`n`t](https://docs.homotechsual.dev/modules/ninjaone/commandlets/New/entityrelations`n`t)
