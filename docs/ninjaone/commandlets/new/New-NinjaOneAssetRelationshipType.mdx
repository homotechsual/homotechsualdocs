...
```powershell
New-NinjaOneAssetRelationshipType [-RelationshipType] <Object> [-ProgressAction <ActionPreference>] [-WhatIf]
...
```powershell
New-NinjaOneAssetRelationshipType -RelationshipType @{ name = 'Depends On' }
```
...
[https://docs.homotechsual.dev/modules/ninjaone/commandlets/New/assetrelationshiptype](https://docs.homotechsual.dev/modules/ninjaone/commandlets/New/assetrelationshiptype)
