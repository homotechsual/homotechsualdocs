...
```powershell
New-NinjaOneBillingAgreement [-BillingAgreement] <Object> [-ProgressAction <ActionPreference>] [-WhatIf]
...
```powershell
New-NinjaOneBillingAgreement -BillingAgreement @{ name = 'Premium Support' }
```
...
[https://docs.homotechsual.dev/modules/ninjaone/commandlets/New/billingagreement](https://docs.homotechsual.dev/modules/ninjaone/commandlets/New/billingagreement)
