...
```powershell
New-NinjaOneBillingInvoice [-billingInvoice] <Object> [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```powershell
New-NinjaOneBillingInvoice -billingInvoice @{ invoiceNumber = 'INV-001' }
```
...
[https://docs.homotechsual.dev/modules/ninjaone/commandlets/New/billinginvoice](https://docs.homotechsual.dev/modules/ninjaone/commandlets/New/billinginvoice)
