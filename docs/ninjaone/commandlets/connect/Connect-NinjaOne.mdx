...
Connect-NinjaOne [-UseWebAuth] -Instance <String> -ClientId <String> -ClientSecret <String>
 [-Scopes <String[]>] [-RedirectURL <Uri>] [-Port <Int32>] [-ShowTokens] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
Connect-NinjaOne [-UseTokenAuth] -Instance <String> -ClientId <String> -ClientSecret <String>
 [-Scopes <String[]>] [-RefreshToken <String>] [-ShowTokens] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
Connect-NinjaOne [-UseClientAuth] -Instance <String> -ClientId <String> -ClientSecret <String>
 [-Scopes <String[]>] [-ShowTokens] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
