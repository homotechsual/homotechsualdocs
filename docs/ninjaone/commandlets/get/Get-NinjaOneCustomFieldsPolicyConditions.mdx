---
title: Get-NinjaOneCustomFieldsPolicyConditions
id: get-ninjaonecustomfieldspolicyconditions
description: "Retrieves the custom field conditions for a given policy id from the NinjaOne v2 API."
hide_title: false
