---
id: Get-NinjaOneOrganisationDocuments
...
```powershell
Get-NinjaOneOrganisationDocuments [-organisationId] <Int32> [-ParseDateTime]
...
Get-NinjaOneOrganisationDocuments [[-documentName] <String>] [[-groupBy] <String>]
 [[-organisationIds] <String>] [[-templateIds] <String>] [[-templateName] <String>] [-ParseDateTime]
 [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
