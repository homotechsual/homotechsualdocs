...
```powershell
Get-NinjaOneSoftwareLicenses [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
[https://docs.homotechsual.dev/modules/ninjaone/commandlets/Get/softwarelicenses](https://docs.homotechsual.dev/modules/ninjaone/commandlets/Get/softwarelicenses)
