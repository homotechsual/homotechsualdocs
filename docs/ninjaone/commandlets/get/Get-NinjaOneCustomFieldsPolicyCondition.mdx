---
title: Get-NinjaOneCustomFieldsPolicyCondition
id: get-ninjaonecustomfieldspolicycondition
description: "Retrieves the detailed information on a given custom field condition for a given policy id from the NinjaOne v2 API."
hide_title: false
