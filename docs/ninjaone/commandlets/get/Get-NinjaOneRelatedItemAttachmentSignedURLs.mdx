---
title: Get-NinjaOneRelatedItemAttachmentSignedURLs
id: get-ninjaonerelateditemattachmentsignedurls
description: "Retrieves a related item attachment signed URLs from the NinjaOne v2 API."
hide_title: false
