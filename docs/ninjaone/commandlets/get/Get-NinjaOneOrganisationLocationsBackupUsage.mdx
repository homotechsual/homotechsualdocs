---
title: Get Organisation Locations Backup Usage
id: organisationlocationsbackupusage
description: "Gets backup usage for all locations in an organisation using the NinjaOne v2 API."
hide_title: false
