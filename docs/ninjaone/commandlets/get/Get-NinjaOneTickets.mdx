...
```powershell
Get-NinjaOneTickets [-ticketId] <Int32> [-ParseDateTime] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
Get-NinjaOneTickets [-boardId] <String> [[-sort] <NinjaOneTicketBoardSort[]>]
 ...
 [[-searchCriteria] <String>] [[-includeColumns] <String[]>] [-includeMetadata] [-ParseDateTime]
