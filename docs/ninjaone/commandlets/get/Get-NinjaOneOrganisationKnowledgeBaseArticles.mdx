---
title: Get-NinjaOneOrganisationKnowledgeBaseArticles
id: get-ninjaoneorganisationknowledgebasearticles
description: "Retrieves knowledge base articles for organisations from the NinjaOne v2 API."
hide_title: false
