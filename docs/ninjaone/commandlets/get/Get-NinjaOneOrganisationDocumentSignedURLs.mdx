---
title: Get-NinjaOneOrganisationDocumentSignedURLs
id: get-ninjaoneorganisationdocumentsignedurls
description: "Retrieves organisation document signed URLs from the NinjaOne v2 API."
hide_title: false
