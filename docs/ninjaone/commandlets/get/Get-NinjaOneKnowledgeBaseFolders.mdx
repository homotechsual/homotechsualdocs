---
title: Get-NinjaOneKnowledgeBaseFolders
id: get-ninjaoneknowledgebasefolders
description: "Retrieves knowledge base folders and information on their contents from the NinjaOne v2 API."
hide_title: false
