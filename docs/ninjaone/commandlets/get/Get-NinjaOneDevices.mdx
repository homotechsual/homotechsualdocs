...
Get-NinjaOneDevices [[-deviceFilter] <String>] [[-pageSize] <Int32>] [[-after] <Int32>] [-detailed]
 [[-expand] <String[]>] [-ParseDateTime] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Single

```powershell
Get-NinjaOneDevices [-deviceId] <Int32> [-ParseDateTime] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
...
```powershell
Get-NinjaOneDevices [[-pageSize] <Int32>] [[-after] <Int32>] [-organisationId] <Int32> [[-expand] <String[]>]
 [-ParseDateTime] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
...
Expand referenced entities in the response.
Valid values: location, organization, rolePolicy, policy, role, backupUsage, warranty, assignedOwner, backupBandwidthThrottle
