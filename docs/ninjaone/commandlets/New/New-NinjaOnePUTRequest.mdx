---
id: New-NinjaOnePUTRequest
title: New-NinjaOnePUTRequest
hide_title: false
...
```powershell
New-NinjaOnePUTRequest [-Resource] <String> [[-QSCollection] <Hashtable>] [-Body] <Hashtable> [-AsArray]
 [<CommonParameters>]
```
...
```powershell
New-NinjaOnePUTRequest -Resource "/v2/organizations -Body @{"name"="MyOrg"}
```
