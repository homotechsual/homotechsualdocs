---
id: Update-NinjaOneLocation
title: Update-NinjaOneLocation
description: "Updates location information using the NinjaOne v2 API."
hide_title: false
...
```powershell
Update-NinjaOneLocation [-organisationId] <Int32> [-locationId] <Int32> [-locationInformation] <Object>
