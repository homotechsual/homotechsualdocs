...
```powershell
Set-NinjaOneBillingProduct [-Id] <Int32> [-BillingProduct] <Object> [-ProgressAction <ActionPreference>]
...
```powershell
Set-NinjaOneBillingProduct -Id 1 -BillingProduct @{ name = 'Updated Product' }
```
...
[https://docs.homotechsual.dev/modules/ninjaone/commandlets/Set/billingproduct](https://docs.homotechsual.dev/modules/ninjaone/commandlets/Set/billingproduct)
