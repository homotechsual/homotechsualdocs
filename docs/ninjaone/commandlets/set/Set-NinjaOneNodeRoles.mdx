...
```powershell
Set-NinjaOneNodeRoles [-nodeRoles] <Object> [-show] [-ProgressAction <ActionPreference>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```powershell
Set-NinjaOneNodeRoles -nodeRoles @(@{ id = 1; name = 'Role A' })
```
...
[https://docs.homotechsual.dev/modules/ninjaone/commandlets/Set/noderoles](https://docs.homotechsual.dev/modules/ninjaone/commandlets/Set/noderoles)
