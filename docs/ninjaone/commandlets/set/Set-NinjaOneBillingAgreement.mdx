...
```powershell
Set-NinjaOneBillingAgreement [-Id] <Int32> [-BillingAgreement] <Object> [-ProgressAction <ActionPreference>]
...
```powershell
Set-NinjaOneBillingAgreement -Id 1 -BillingAgreement @{ name = 'Updated Agreement' }
```
...
[https://docs.homotechsual.dev/modules/ninjaone/commandlets/Set/billingagreement](https://docs.homotechsual.dev/modules/ninjaone/commandlets/Set/billingagreement)
