...
```powershell
Set-NinjaOneBillingAccount [-id] <Int32> [-billingAccount] <Object> [-ProgressAction <ActionPreference>]
...
```powershell
Set-NinjaOneBillingAccount -id 1 -billingAccount @{ name = 'Updated Account' }
```
...
[https://docs.homotechsual.dev/modules/ninjaone/commandlets/Set/billingaccount](https://docs.homotechsual.dev/modules/ninjaone/commandlets/Set/billingaccount)
