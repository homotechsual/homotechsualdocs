---
title: Remove-NinjaOneRelatedItems
id: remove-ninjaonerelateditems
description: "Removes the item relationships for the given entity type and entity id using the NinjaOne v2 API."
hide_title: false
