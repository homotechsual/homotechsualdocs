---
title: Remove-NinjaOneOrganisationDocument
id: remove-ninjaoneorganisationdocument
description: "Removes the specified organisation document using the NinjaOne v2 API."
hide_title: false
