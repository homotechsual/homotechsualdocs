---
id: Update-NinjaOneNodeRolePolicyAssignment
title: Update-NinjaOneNodeRolePolicyAssignment
description: "Updates policy assignment for node role(s) using the NinjaOne v2 API."
hide_title: false
...
```powershell
Update-NinjaOneNodeRolePolicyAssignment [-organisationId] <Int32> [-nodeRoleId] <Int32> [-policyId] <Int32>
