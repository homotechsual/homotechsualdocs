---
id: Set-NinjaOneDeviceCustomFields
title: Set-NinjaOneDeviceCustomFields
...
```powershell
Set-NinjaOneDeviceCustomFields [-deviceId] <String[]> [-deviceCustomFields] <Object> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
