...
Required: False
Position: Named
Default value: $PSCmdlet.ParameterSetName -eq 'Client Credentials' ? @('monitoring', 'management', 'control') : @('monitoring', 'management', 'control', 'offline_access')
Accept pipeline input: False
Accept wildcard characters: False
```
