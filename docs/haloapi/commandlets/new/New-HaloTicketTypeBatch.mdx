...
description: "Function to send a batch of ticket type creation requests to the Halo API"
hide_title: false
...
```powershell
New-HaloTicketTypeBatch [-TicketTypes] <Array[]> [[-BatchSize] <Int32>] [[-BatchWait] <Int32>]
