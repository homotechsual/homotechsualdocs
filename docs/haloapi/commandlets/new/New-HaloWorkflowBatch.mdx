...
description: "Function to send a batch of workflow creation requests to the Halo API"
hide_title: false
...
```powershell
New-HaloWorkflowBatch [-Workflows] <Array[]> [[-BatchSize] <Int32>] [[-BatchWait] <Int32>]
