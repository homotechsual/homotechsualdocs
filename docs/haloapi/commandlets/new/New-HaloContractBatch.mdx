...
description: "Function to send a batch of contract creation requests to the Halo API"
hide_title: false
...
```powershell
New-HaloContractBatch [-Contracts] <Array[]> [[-BatchSize] <Int32>] [[-BatchWait] <Int32>]
