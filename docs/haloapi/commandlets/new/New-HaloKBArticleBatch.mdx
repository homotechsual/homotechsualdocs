...
description: "Function to send a batch of knowledgebase article creation requests to the Halo API"
hide_title: false
...
```powershell
New-HaloKBArticleBatch [-KBArticles] <Array[]> [[-BatchSize] <Int32>] [[-BatchWait] <Int32>]
