...
description: "Function to send a batch of custom field creation requests to the Halo API"
hide_title: false
...
```powershell
New-HaloCustomFieldBatch [-CustomFields] <Array[]> [[-BatchSize] <Int32>] [[-BatchWait] <Int32>]
