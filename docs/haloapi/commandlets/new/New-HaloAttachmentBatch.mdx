...
description: "Function to send a batch of attachment creation requests to the Halo API"
hide_title: false
...
```powershell
New-HaloAttachmentBatch [-Attachments] <Array[]> [[-BatchSize] <Int32>] [[-BatchWait] <Int32>]
