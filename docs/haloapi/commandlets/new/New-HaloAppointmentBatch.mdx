...
description: "Function to send a batch of appointment creation requests to the Halo API"
hide_title: false
...
```powershell
New-HaloAppointmentBatch [-Appointments] <Array[]> [[-BatchSize] <Int32>] [[-BatchWait] <Int32>]
