...
description: "Function to send a batch of opportunity creation requests to the Halo API"
hide_title: false
...
```powershell
New-HaloOpportunityBatch [-Opportunities] <Array[]> [[-BatchSize] <Int32>] [[-BatchWait] <Int32>]
