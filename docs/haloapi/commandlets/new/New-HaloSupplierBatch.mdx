...
description: "Function to send a batch of supplier creation requests to the Halo API"
hide_title: false
...
```powershell
New-HaloSupplierBatch [-Suppliers] <Array[]> [[-BatchSize] <Int32>] [[-BatchWait] <Int32>]
