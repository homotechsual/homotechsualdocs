...
id: connect-haloapi
description: "Creates a new connection to a Halo instance and stores this in a PowerShell Session."
hide_title: false
...
Connect-HaloAPI -URL <Uri> -ClientID <String> -ClientSecret <String> [-Scopes <String[]>] [-Tenant <String>]
 ...
 [-SaveToKeyVault <Boolean>] [-Identity <String>] [-MaxRetries <Int32>] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
