---
title: Get-HaloViewListGroup
id: get-haloviewlistgroup
description: "Retrieves view list group from the Halo API - supports a variety of list grouping parameters."
hide_title: false
...
```powershell
Get-HaloViewListGroup [-Type <String>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```

### Single

```powershell
Get-HaloViewListGroup -ViewListGroupId <Int64> [-IncludeDetails] [-ProgressAction <ActionPreference>]
 [<CommonParameters>]
```
