...
description: "Retrieves attachments from the Halo API - supports a variety of filtering parameters."
hide_title: false
...
```powershell
Get-HaloAttachment -AttachmentID <Int64> [-IncludeDetails] [-AsBase64] [-GetToken] [<CommonParameters>]
```
