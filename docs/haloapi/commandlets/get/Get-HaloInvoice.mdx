...
id: get-haloinvoice
description: "Retrieves invoices from the Halo API - supports a variety of filtering parameters."
hide_title: false
...
Get-HaloInvoice [-Count <Int32>] [-Search <String>] [-Paginate] [-PageSize <Int32>] [-PageNo <Int32>]
 ...
 [-PaymentStatuses <String>] [-PaymentStatusIds <Int64[]>] [<CommonParameters>]
```
