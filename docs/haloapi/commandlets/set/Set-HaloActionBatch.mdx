...
description: "Function to send a batch of action update requests to the Halo API"
hide_title: false
...
```powershell
Set-HaloActionBatch [-Actions] <Array[]> [[-BatchSize] <Int32>] [[-BatchWait] <Int32>] [-SkipValidation]
