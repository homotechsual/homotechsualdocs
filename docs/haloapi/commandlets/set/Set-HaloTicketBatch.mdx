...
description: "Function to send a batch of ticket update requests to the Halo API"
hide_title: false
...
```powershell
Set-HaloTicketBatch [-Tickets] <Array[]> [[-BatchSize] <Int32>] [[-BatchWait] <Int32>] [-SkipValidation]
