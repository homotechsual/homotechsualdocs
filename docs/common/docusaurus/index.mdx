...
This site is built using [Docusaurus](https://docusaurus.io/) and deployed through a Cloudflare Worker that serves the generated static assets.
...
The pipeline then commits the generated documentation to the `docs` directory of this repository, which is then built and deployed through GitHub Actions to Cloudflare Workers.
